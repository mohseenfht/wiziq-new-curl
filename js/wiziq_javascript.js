...
jQuery(document).ready(function() {
   ...
   var valThis = jQuery(this).val().toLowerCase(); 
    jQuery('#wiziq-enroll-user option').each(function(){       
     var text = jQuery(this).text().toLowerCase();
        (text.indexOf(valThis) >= 0) ? jQuery(this).show() : jQuery(this).hide();            
   });
});  

jQuery('#allserach').keyup(function(){
   var valThis = jQuery(this).val().toLowerCase(); 
    jQuery('#wiziq-all-user option').each(function(){       
     var text = jQuery(this).text().toLowerCase();
        (text.indexOf(valThis) >= 0) ? jQuery(this).show() : jQuery(this).hide();            
   });
}); 
  ...
  /* on click of search text box remove place holder value */
	...
	if ( delete_action_course == 1) {
		...
		jQuery('.courses').each( function () {
			...
			//if ( jQuery('#cb-select-'+courseid ).attr("checked") ){
  			if ( jQuery('#cb-select-'+courseid ).prop("checked") ){                      
 ...
 jQuery(document).ready(function(){
	...
	jQuery('#wiziq-add-user').click(function () {
       ...
       //alert(permission_val);
			...
			permission_string += '<td><input type="hidden" value="0" name="create_class['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked +user_disable+' name="create_class['+jQuery(option).val()+']" class="'+permission_class+'" id="create_class_'+jQuery(option).val()+'" /> </td>'; 
			...
			permission_string += '<td><input type="hidden" value="0" name="download_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked + ' name="download_recording['+jQuery(option).val()+']" class="download_recording" checked = "checked" /> </td>';
			permission_string += '<td><input type="hidden" value="0" name="upload_content['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked + user_disable+' name="upload_content['+jQuery(option).val()+']" class="'+permission_class+'" id="'+jQuery(option).val()+'"/> </td>';
			...
			permission_string += '<tr id=enroll_'+jQuery(option).val()+'>';
			permission_string += '<td><input type="hidden" name="user_id[]" value="'+jQuery(option).val()+'" />'+jQuery(option).text() +'</td>';
			permission_string += '<td><input type="hidden" value="0" name="create_class['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked +user_disable+' name="create_class['+jQuery(option).val()+']" class="'+permission_class+'" id="create_class_'+jQuery(option).val()+'" disabled /> </td>'; 
			permission_string += '<td><input type="hidden" value="0" name="view_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox" name="view_recording['+jQuery(option).val()+']" class="view_recording" checked = "checked" /> </td>';
			permission_string += '<td><input type="hidden" value="0" name="download_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked + ' name="download_recording['+jQuery(option).val()+']" class="download_recording" checked = "checked" /> </td>';
			permission_string += '<td><input type="hidden" value="0" name="upload_content['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked + user_disable+' name="upload_content['+jQuery(option).val()+']" class="'+permission_class+'" id="'+jQuery(option).val()+'" disabled /> </td>';
			permission_string += '</tr>';                                
...
/* Start custom code to show error msg on stype string in class_attendee_limit */

/* jQuery(document).on('blur','#class_attendee_limit' , function () {
	jQuery('#class_attendee_limit_err').empty();
	var class_att_li = jQuery('#class_attendee_limit').val().trim();
	if ( !class_att_li.match(/^\d+$/) ) {
		var duration_msg = jQuery('#class_attendee_number_error').html();
		jQuery('#class_attendee_limit_err').html(duration_msg);
		ret = false;
	}
    }); *
    
/*End custom code to show error msg on stype string in class_attendee_limit */
...
jQuery( document ).on('change','#class_schedule' , function () {
	var checked = jQuery(this).attr('checked');
	 ...
	 if(jQuery(this).is(':checked')){
            //alert(jQuery.datepicker.formatDate('mm/dd/yy', new Date()));
...
jQuery (document).on ('click' , '#delete-content' , function () {
	...
	if ( delete_action_course == 1) {
		jQuery('.content').each( function () {
			...
			if ( jQuery('#cb-select-'+newcontentid ).prop("checked") ){
				count++;
