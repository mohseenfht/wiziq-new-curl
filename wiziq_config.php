 ...
 * @since 1.0
 */
define("WIZIQ_COM_COMMAN_MESSAGE", 'There is an error while processing your request please contact to wiziq support . If you have not added WizIQ API keys,please add these on the setting page.' );
